...
export async function sendEmail({
  ...
  // Set this to `true` if you want to log your emails and not send them
  if (process.env.RESEND_DEV_RUN === "true") {
    console.info(chalk.blueBright("\n✉️  Mock email:"));
    console.info(chalk.blueBright(JSON.stringify(email, null, 2)));
